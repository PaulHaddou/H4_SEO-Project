...
<div class="main">
    ...
    <img src="../../../pictures/K-RO_Petite-Sirene-Carreau-Motif-2.png" alt="Image de Carreau de La petite sirene" class="left_container_img">

    </div>
    <div class="right_container">
        <div class="main_content-1_elements">
            <p class="right_container_title_txt"><?= $Product_Main_Title_Sirene ?></p>
        </div>
        <div class="main_content-2_elements">   
            <p class="right_container_small_title_txt"><?= $Product_Content_1_Small_Title ?></p>
            <p class="right_container_body_txt"><?= $Product_Content_1_Body_Sirene ?></p>
        </div>
